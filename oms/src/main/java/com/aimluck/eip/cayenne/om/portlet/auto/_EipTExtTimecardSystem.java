...
public class _EipTExtTimecardSystem extends org.apache.cayenne.CayenneDataObject {
    ...
    public void setAfternoonOff(Integer afternoonOff) {
        writeProperty("afternoonOff", afternoonOff);
    }
    public Integer getAfternoonOff() {
        return (Integer)readProperty("afternoonOff");
    }
    ...
    public void setMorningOff(Integer morningOff) {
        writeProperty("morningOff", morningOff);
    }
    public Integer getMorningOff() {
        return (Integer)readProperty("morningOff");
    }
