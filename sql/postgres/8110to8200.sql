...
-- 20170825
ALTER TABLE EIP_T_EXT_TIMECARD_SYSTEM ADD RESTTIME_START_HOUR INTEGER;
ALTER TABLE EIP_T_EXT_TIMECARD_SYSTEM ADD RESTTIME_START_MINUTE INTEGER;
ALTER TABLE EIP_T_EXT_TIMECARD_SYSTEM ADD RESTTIME_END_HOUR INTEGER;
ALTER TABLE EIP_T_EXT_TIMECARD_SYSTEM ADD RESTTIME_END_MINUTE INTEGER;
ALTER TABLE EIP_T_EXT_TIMECARD_SYSTEM ADD RESTTIME_TYPE VARCHAR (1) DEFAULT 'P';
