...
(
    ...
    RESTTIME_START_HOUR INTEGER DEFAULT 12,
    RESTTIME_START_MINUTE INTEGER DEFAULT 0,
    RESTTIME_END_HOUR INTEGER DEFAULT 13,
    RESTTIME_END_MINUTE INTEGER DEFAULT 0,
